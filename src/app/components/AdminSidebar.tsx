"use client"
import { BriefcaseMedical, ClipboardPlus, Home, LayoutDashboard, LogOut, PanelLeft, PlusCircle, User, Users } from 'lucide-react'
...
const AdminSidebar = ({setCurrentMenu}:propType) => {
