"use client"
import { BriefcaseMedical, ClipboardPlus, Home, LayoutDashboard, LogOut, PlusCircle, ShieldUser, User, Users, X } from 'lucide-react'
...
const SuperAdminMobileSidebar = ({setCurrentMenu,setOpenMobileSidebar}:propType) => {
